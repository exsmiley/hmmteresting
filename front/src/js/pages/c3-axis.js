...
$(function () {
	...
	var a = c3.generate({
	 ...
	 var t = c3.generate({
        ...
        axis: { x: { type: "data", categories: ["2010", "2011", "2012", "2013", "2014", "2015", "2016", "2023", "2018"] } },
        grid: { y: { show: !0 } }
    });
	...
	var i = c3.generate({
        ...
        data: {
            x: "x",
            columns: [
                ["x", "2018-04-21", "2018-03-21", "2018-02-21", "2018-01-21", "2023-12-21", "2023-11-21", "2023-10-21"],
	...
	var t = c3.generate({
        ...
        data: {
            ...
            xFormat: "%Y",
            columns: [
                	['x', '2010-12-22', '2011-12-24', '2012-12-28', '2013-12-31', '2014-01-01', '2015-01-02', '2016-01-03', '2023-01-04', '2018-01-05'],
					['x', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2023', '2018'],
